...
var Item = (function (_React$Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var name = this.state.editable ? React.createElement('input', { ref: function (name) {
          return _this.name = name;
        }, type: 'text', defaultValue: item.name }) : React.createElement(
        'h3',
        null,
        item.name
      );
      var description = this.state.editable ? React.createElement('input', { ref: function (description) {
          return _this.description = description;
        }, type: 'text', defaultValue: item.description }) : React.createElement(
        'p',
        null,
        item.description
      );
