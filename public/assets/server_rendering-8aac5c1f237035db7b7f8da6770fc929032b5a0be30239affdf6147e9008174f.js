      ...
      var items = this.props.items.map(function (item) {
        return React.createElement(
          ...
          React.createElement(Item, {
            ...
            handleUpdate: _this.handleUpdate.bind(_this) })
        );
      });
...
var Body = (function (_React$Component) {
  ...
  _createClass(Body, [{
    ...
    key: 'handleNewItem',
    value: function handleNewItem(item) {
      this.setState({ items: this.state.items.concat(item) });
    }
  }, {
    key: 'handleItemDeletion',
    value: function handleItemDeletion(id) {
      var _this2 = this;
      ...
      $.ajax({
        ...
        success: function () {
          _this2.setState({
            items: _this2.state.items.filter(function (item) {
              return item.id != id;
            })
          });
        }
    ...
    value: function handleItemUpdate(item) {
      var _this3 = this;
      ...
      $.ajax({
        ...
        success: function (response) {
          var items = _this3.state.items.filter(function (i) {
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement(NewItem, { handleNewItem: this.handleNewItem }),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  this.props.item.updated_at != this.props.item.created_at && React.createElement(
                    "span",
                    {
                      title: new Date(this.props.item.updated_at).toLocaleString(),
                      className: "badge badge badge-info float-right" },
                    "Updated"
                  )
                ),
                React.createElement(
...
var NewItem = (function (_React$Component) {
  ...
  _createClass(NewItem, [{
    ...
    value: function handleSubmit(event) {
      ...
      $.ajax({
        ...
        success: function (item) {
          _this.props.handleNewItem(item);
          _this.setState({
            name: '',
            description: '',
            errors: {}
        ...
        error: function (xhr, status, err) {
          _this.handleNewItemError(xhr.responseJSON.errors);
        }
      });
    ...
    key: 'handleNewItemError',
    value: function handleNewItemError(errors) {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'name' in this.state.errors && React.createElement(
                'div',
            ...
            React.createElement(
              ...
              React.createElement('textarea', {
                ...
                onChange: this.handleChange }),
              'description' in this.state.errors && React.createElement(
                'div',
                { className: 'invalid-feedback' },
